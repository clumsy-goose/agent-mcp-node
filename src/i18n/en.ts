const en = {
  ...
  "auth.gen.success": "Generated",
  "auth.gen.copy": "Copy",
  "auth.gen.copied": "Copied",
  "auth.gen.filled": "This token has also been saved into the JWT Token field above and is ready for the /whoami probe.",
